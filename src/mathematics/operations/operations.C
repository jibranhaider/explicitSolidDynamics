...
dimensionedScalar operations::minimumEdgeLength()
{
    ...
    {
        forAll(mesh_.edges()[edgeID], pointi)
        {
            const label& pointID0 = mesh_.edges()[edgeID][pointi];
            const label& pointID1 = mesh_.edges()[edgeID][pointi + 1];
            const scalar& edgeLength =
                mag(mesh_.points()[pointID0] - mesh_.points()[pointID1]);
...
volTensorField operations::invT
(
...
) const
{
    ...
    GeometricField<tensor, fvPatchField, volMesh> inv = tsf();
...
) const
{
    ...
    GeometricField<vector, fvPatchField, volMesh> Vx = tvf();
...
volVectorField operations::decomposeTensorY
(
    const GeometricField<tensor, fvPatchField, volMesh>& T
) const
{
    ...
    GeometricField<vector, fvPatchField, volMesh> Vy = tvf();
...
volVectorField operations::decomposeTensorZ
(
    const GeometricField<tensor, fvPatchField, volMesh>& T
) const
{
    ...
    GeometricField<vector, fvPatchField, volMesh> Vz = tvf();
